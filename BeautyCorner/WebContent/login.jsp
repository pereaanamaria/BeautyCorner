   ...
   <p>Te rugăm să introduci datele tale!</p>
    ...
    <form method="post" action="Login">
        ...
        <div class="form-group">
            <input type="text" name="username" class="form-control" placeholder="Username" required="required" data-validation-required-message="Completează cu un nume de utilizator valid!">
        </div>
        ...
        <div class="forgot">
        <p align="center">Nu ai cont? <a href="register.jsp">Înregistrează-te.</a></p>
        </div>
