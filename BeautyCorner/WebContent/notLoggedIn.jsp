...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
          	...
          	<li class="nav-item">
              <a class="nav-link js-scroll-trigger active" href="login.jsp">Login</a>
            </li>
            
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger active" href="register.jsp">Register</a>
            </li>
	...
	<section>
		...
		<br><br>
		<h3 align="center">Se pare că nu ai intrat pe contul tău.</h3>
		<br><br><br>
		<p align="center">Intră în contul tău, mai întai! Dacă nu ai cont, te poți înregistra apăsând butonul de <b>register</b></p>
	</section>
    <%
