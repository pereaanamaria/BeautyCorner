...
<html lang="en">
  ...
  <body id="page-top">
      	...
      	try{
      		...
      		if(session!=null)
      		{
      			...
      			if(username.equals("admin")) {
      				%>
      					<a class="navbar-brand js-scroll-trigger" href="http://localhost:8082/Admin/admin.jsp">Beauty Corner</a>
      				<%
      			} else {
      				%>
	...
	<section>
		<h1 align="center">Stergerea programarii s-a efectuat cu succes!</h1>
	</section>
