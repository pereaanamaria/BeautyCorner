  ...
  <body id="page-top">
    ...
    <%	
    	...
    	try{
    		...
    		if(session!=null) {
    			userid = request.getAttribute("id_user").toString();
    		}
    	} catch(Exception e) {System.out.println(e);}
    %>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="http://localhost:8080/BeautyCorner/index.jsp?<%=userid%>">Beauty Corner</a>
	...
	<section>
		<h1 align="center">Programarea s-a efectuat cu succes!</h1>
	</section>
